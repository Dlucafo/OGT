...
- Fixes an issue where `require("markojs/components").getComponentForEl` could return undefined when a component exists, or the wrong component, when nested fragments are present. [#1382](https://github.com/marko-js/marko/pull/1382)
...
```javascript
require("markojs/compiler").defaultOptions.writeToDisk = false;
```
